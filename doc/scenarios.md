...
As a player,
    I want to win a level and be able to advance to the next level without losing my score and I keep doing that untill I win the last level.
    there by winning the game.
    If I die at any point I have to restart from the begginging.
    
Scenario 5.1
Given that the player has won the fist level, 
